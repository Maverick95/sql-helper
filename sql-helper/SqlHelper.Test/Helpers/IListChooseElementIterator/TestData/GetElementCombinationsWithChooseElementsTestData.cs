...
{
    public class GetElementCombinationsWithChooseElementsTestData: TheoryData<int, int, IList<IList<int>>>
    {
        public GetElementCombinationsWithChooseElementsTestData()
        {
